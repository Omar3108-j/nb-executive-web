                  ...
                  >
                    ...
                    <div className="flex h-full w-full flex-col">
                      <div className="relative h-56 overflow-hidden">
                        ...
                        <div className="pointer-events-none absolute inset-0 opacity-0 transition duration-500 group-hover:opacity-100 bg-[radial-gradient(circle_at_center,rgba(59,130,246,0.24),transparent_45%)]" />
